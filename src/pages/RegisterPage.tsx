...
import {UseRegisterVisitor} from "../services";
...
const RegisterPage: React.FC = () => {
    ...
    const {isPending: isRegistering, mutate: registerVisitor, data: registerResult} = UseRegisterVisitor()
    ...
    useEffect(() => {
        if (registerResult) {
            if (registerResult?.responseData?.error) {
                toast.error(registerResult?.responseData?.message || "Erreur lors de l'enregistrement")
            } else {
                ...
                <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                    <div className="p-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            >
                                {isRegistering ? 'Creating account...' : t('auth.register.submit')}
                            </button>
