...
// Données par défaut pour les champs optionnels
...
const prevStep = () => setCurrentStep(prev => prev - 1);
                  ...
                  {showDropdown && (
                    <div className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                      {filteredCategories.length === 0 ? (
                        <div className="px-4 py-2 text-sm text-gray-700">Aucun résultat trouvé</div>
                      ) : (
      ...
      case 3:
        return (
          <div className="text-center">
            ...
            <h3 className="mt-3 text-lg font-medium text-gray-900">Veillez à confirmer votre candidature</h3>
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section className="relative py-28 md:py-36 overflow-hidden bg-gradient-to-r from-primary-700 to-primary-900">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80')] bg-cover bg-center opacity-20"></div>
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Rejoignez une entreprise en pleine croissance et participez à des projets ambitieux dans le domaine du transport et de la logistique en RDC.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Nos offres d'emploi</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredOffers.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-16 px-4 bg-white rounded-xl border-2 border-dashed border-gray-200">
                    <div className="mx-auto w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-4">
                      <Briefcase className="w-8 h-8 text-gray-400" />
                    </div>
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune offre ne correspond à vos critères</h3>
                    <p className="text-gray-600 mb-6 max-w-md mx-auto">
                      Nous n'avons trouvé aucune offre correspondant à votre recherche. Essayez de modifier vos filtres ou revenez plus tard.
                    </p>
                    <button
                      onClick={resetFilters}
      ...
      {selectedOffer && (
        <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true" onClick={() => setSelectedOffer(null)}></div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4 space-y-6">
                      <div className="bg-gray-50 p-4 rounded-lg">
                          ...
                          <div className="flex items-start">
                            <div className="flex-shrink-0 h-10 w-10 rounded-full bg-amber-100 flex items-center justify-center">
                              <svg className="h-5 w-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M12 16h.01"></path>
                              </svg>
                            </div>
                            <div className="ml-3">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg className="h-4 w-4 text-gray-400 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                              </svg>
                              <span className="text-sm text-gray-500">Publié le {selectedOffer.publishedDate}</span>
                            </div>
                            <div className="flex items-center">
                              <svg className="h-4 w-4 text-red-400 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                              </svg>
                              <span className="text-sm font-medium text-red-600">Clôture: {selectedOffer.closingDate}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="prose max-w-none">
                        ...
                        <h4 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Missions principales</h4>
                        ...
                        {selectedOffer.requirements && selectedOffer.requirements.length > 0 && (
                          <div className="mt-4">
                            <h4 className="text-sm font-medium text-gray-900 mb-2">Profil recherché</h4>
      ...
      <section id="apply-now" className="py-16 bg-gradient-to-r from-primary-700 to-primary-900 text-white">
        <div className="container-custom px-4 text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl text-white md:text-4xl font-bold mb-6">Vous cherchez a commencer votre carrière ?</h2>
            <p className="text-xl text-primary max-w-3xl mx-auto mb-8">
              Envoyez-nous votre profil. Notre équipe l'examinera et vous contactera si un poste vous correspond .
            </p>
        ...
        <div className="container-custom px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-primary-50 mb-4 mx-auto">
                  {item.icon}
                </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          ...
          >
            <div className="sticky top-0 bg-white z-10 px-6 pt-6 pb-4 border-b border-gray-200 rounded-t-xl">
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep >= 1 ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
                    1
                  </div>
                  <div className={`h-1 w-8 mx-1 ${currentStep >= 2 ? 'bg-primary-600' : 'bg-gray-200'}`}></div>
                  <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep >= 2 ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
                    2
                  </div>
                  <div className={`h-1 w-8 mx-1 ${currentStep >= 3 ? 'bg-primary-600' : 'bg-gray-200'}`}></div>
                  <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep >= 3 ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
                    3
                  </div>
                </div>
