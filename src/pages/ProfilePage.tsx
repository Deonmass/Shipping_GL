...
import { User, Mail, Phone, Building2, MapPin, Calendar, Settings, Key, Edit, CheckCircle, ArrowRight } from 'lucide-react';
import toast from 'react-hot-toast';

interface PartnerProfile {
  partner_code?: string;
  partner_type?: 'physical' | 'legal';
  first_name?: string;
  last_name?: string;
  company_name?: string;
  email?: string;
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Pour accéder à toutes les fonctionnalités, veuillez mettre à jour vos informations de profil.
              </p>
            </div>
            <Link
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Code Partenaire: {profile?.partner_code}
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-gray-900">
                        {profile?.partner_type === 'legal' ? 'Personne Morale' : 'Personne Physique'}
                      </p>
                    </div>
