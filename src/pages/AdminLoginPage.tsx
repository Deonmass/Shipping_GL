...
const AdminLoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRolesError) {
        console.error('userRolesError:', userRolesError);
        throw new Error(userRolesError.message || 'Erreur lors de la vérification des rôles');
      }
      ...
      if (roleIds.length > 0) {
        ...
        if (rolesError) {
          ...
          throw new Error(rolesError.message || 'Erreur lors de la vérification des rôles admin');
        }
