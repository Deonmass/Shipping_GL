...
import { Search, ChevronDown, Calendar as CalendarIcon, FileText, Tag, TrendingUp, MessageCircle, Share2, X } from 'lucide-react';
      ...
      <div className="flex flex-col space-y-3">
        ...
        <div className="flex items-center justify-around space-x-2">
          <div ref={categoryRef} className="relative flex-1">
            ...
            {showCategoryMenu && (
              <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 max-h-64 overflow-y-auto z-50 min-w-full">
                <button
                  onClick={() => {
          ...
          <div ref={calendarRef} className="relative flex-1">
            ...
            {showCalendar && (
              <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50 min-w-max">
          ...
          <div ref={sortRef} className="relative flex-1">
            ...
            {showSortMenu && (
              <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 z-50 min-w-full">
                <button
                  onClick={() => {
                    onSortChange('likes');
                    setShowSortMenu(false);
